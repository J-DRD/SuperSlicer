#include "ExtrusionPaintingTab.hpp"
...
ExtrusionPaintingTab::ExtrusionPaintingTab(wxWindow* parent) : wxPanel(parent) {
...
void ExtrusionPaintingTab::on_preview_button_click(wxCommandEvent& event) {
